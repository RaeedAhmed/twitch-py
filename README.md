...
You will need a media player of your choice (`mpv`, `vlc`, etc.). Be sure to change the player and its arguments located in `~/.config/twitch-py/config/settings.toml`
